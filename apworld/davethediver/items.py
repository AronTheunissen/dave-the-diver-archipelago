...
restaurant_items: Dict[str, ItemData] = {
    ...
    # === ALL RESEARCHABLE COOKED DISHES (AP-gated) ===
    # These correspond 1:1 with the 88 "Unlock Recipe: X" locations added 2026-07-10.
    # Receiving one of these makes the dish researchable AND auto-researches it to level 1.
    # IDs: ITEM_BASE + 1000 .. ITEM_BASE + 1087
    # (Chosen to avoid all existing ranges: 0-23 weapons, 100-399 various, 500-535 charms,
    #  600-669 fillers, 700-714 traps, 750-797 flavor, 800-848 jungle, 850-923 staff)
    "Recipe: Agar Tokoroten":                        ItemData(ITEM_BASE + 1000, ItemClassification.useful, category="recipe"),
    "Recipe: Batfish Ricebowl":                      ItemData(ITEM_BASE + 1001, ItemClassification.useful, category="recipe"),
    "Recipe: Big-Eyed Scad and Soybean Paste Roast": ItemData(ITEM_BASE + 1002, ItemClassification.useful, category="recipe"),
    "Recipe: Black Vinegar Braised Parrotfish":      ItemData(ITEM_BASE + 1003, ItemClassification.useful, category="recipe"),
    "Recipe: Bluefin Tuna Rice Bowl":                ItemData(ITEM_BASE + 1004, ItemClassification.useful, category="recipe"),
    "Recipe: Boiled Asian Sheepshead Wrasse & Truffle": ItemData(ITEM_BASE + 1005, ItemClassification.useful, category="recipe"),
    "Recipe: Boiled Porbeagle Shark":                ItemData(ITEM_BASE + 1006, ItemClassification.useful, category="recipe"),
    "Recipe: Boiled Sailfish and Seaweed":           ItemData(ITEM_BASE + 1007, ItemClassification.useful, category="recipe"),
    "Recipe: Boiled Yellowback Fusilier":            ItemData(ITEM_BASE + 1008, ItemClassification.useful, category="recipe"),
    "Recipe: Boiled and Deep-Fried White Shrimp":    ItemData(ITEM_BASE + 1009, ItemClassification.useful, category="recipe"),
    "Recipe: Crimson Fish Roll":                     ItemData(ITEM_BASE + 1010, ItemClassification.useful, category="recipe"),
    "Recipe: Crystal Lobster Roll":                  ItemData(ITEM_BASE + 1011, ItemClassification.useful, category="recipe"),
    "Recipe: Deep-Fried Eggplant Shrimp Meatballs":  ItemData(ITEM_BASE + 1012, ItemClassification.useful, category="recipe"),
    "Recipe: Deep-Fried Red Lionfish":               ItemData(ITEM_BASE + 1013, ItemClassification.useful, category="recipe"),
    "Recipe: Deep-Fried Vegetables":                 ItemData(ITEM_BASE + 1014, ItemClassification.useful, category="recipe"),
    "Recipe: Dried Stingray":                        ItemData(ITEM_BASE + 1015, ItemClassification.useful, category="recipe"),
    "Recipe: Dusky Grouper Steak":                   ItemData(ITEM_BASE + 1016, ItemClassification.useful, category="recipe"),
    "Recipe: Falcatus Soybean Paste Soup":           ItemData(ITEM_BASE + 1017, ItemClassification.useful, category="recipe"),
    "Recipe: Fried Habanero Fangtooth":              ItemData(ITEM_BASE + 1018, ItemClassification.useful, category="recipe"),
    "Recipe: Fried Onion Cuttlefish":                ItemData(ITEM_BASE + 1019, ItemClassification.useful, category="recipe"),
    "Recipe: Fried Rice with Sally Lightfoot Crab":  ItemData(ITEM_BASE + 1020, ItemClassification.useful, category="recipe"),
    "Recipe: Fried Seahorses":                       ItemData(ITEM_BASE + 1021, ItemClassification.useful, category="recipe"),
    "Recipe: Fried Tomato and Snailfish":            ItemData(ITEM_BASE + 1022, ItemClassification.useful, category="recipe"),
    "Recipe: Great Spider Crab Curry":               ItemData(ITEM_BASE + 1023, ItemClassification.useful, category="recipe"),
    "Recipe: Great Spider Crab and Cucumber Sushi":  ItemData(ITEM_BASE + 1024, ItemClassification.useful, category="recipe"),
    "Recipe: Grilled Antarctic Octopus & Truffle":   ItemData(ITEM_BASE + 1025, ItemClassification.useful, category="recipe"),
    "Recipe: Grilled Eel with Habanero":             ItemData(ITEM_BASE + 1026, ItemClassification.useful, category="recipe"),
    "Recipe: Hawaiian Poke":                         ItemData(ITEM_BASE + 1027, ItemClassification.useful, category="recipe"),
    "Recipe: Hot Pepper Tuna":                       ItemData(ITEM_BASE + 1028, ItemClassification.useful, category="recipe"),
    "Recipe: Hyalonema Tuna Sashimi":                ItemData(ITEM_BASE + 1029, ItemClassification.useful, category="recipe"),
    "Recipe: Ice Fish Curry":                        ItemData(ITEM_BASE + 1030, ItemClassification.useful, category="recipe"),
    "Recipe: Latok Omelet":                          ItemData(ITEM_BASE + 1031, ItemClassification.useful, category="recipe"),
    "Recipe: Lobster Platter":                       ItemData(ITEM_BASE + 1032, ItemClassification.useful, category="recipe"),
    "Recipe: Mackerel Scad Hotdog":                  ItemData(ITEM_BASE + 1033, ItemClassification.useful, category="recipe"),
    "Recipe: Marlin and Soybean Paste Roast":        ItemData(ITEM_BASE + 1034, ItemClassification.useful, category="recipe"),
    "Recipe: Mianbao Xia":                           ItemData(ITEM_BASE + 1035, ItemClassification.useful, category="recipe"),
    "Recipe: Moonlight Bladderwrack Roll":           ItemData(ITEM_BASE + 1036, ItemClassification.useful, category="recipe"),
    "Recipe: Moray Eel Curry":                       ItemData(ITEM_BASE + 1037, ItemClassification.useful, category="recipe"),
    "Recipe: Narrow-barred Spanish Mackerel Arancini": ItemData(ITEM_BASE + 1038, ItemClassification.useful, category="recipe"),
    "Recipe: Narwhal Miso Soup":                     ItemData(ITEM_BASE + 1039, ItemClassification.useful, category="recipe"),
    "Recipe: Nasu Dengaku":                          ItemData(ITEM_BASE + 1040, ItemClassification.useful, category="recipe"),
    "Recipe: Pelican Eel Jelly":                     ItemData(ITEM_BASE + 1041, ItemClassification.useful, category="recipe"),
    "Recipe: Pickled Vegetables":                    ItemData(ITEM_BASE + 1042, ItemClassification.useful, category="recipe"),
    "Recipe: Pikaia Ramen":                          ItemData(ITEM_BASE + 1043, ItemClassification.useful, category="recipe"),
    "Recipe: Plotosid Pie":                          ItemData(ITEM_BASE + 1044, ItemClassification.useful, category="recipe"),
    "Recipe: Pufferfish Dumpling Soup":              ItemData(ITEM_BASE + 1045, ItemClassification.useful, category="recipe"),
    "Recipe: Rice with Great Spider Crab Meat":      ItemData(ITEM_BASE + 1046, ItemClassification.useful, category="recipe"),
    "Recipe: Rice with Purple Sea Urchin Sushi":     ItemData(ITEM_BASE + 1047, ItemClassification.useful, category="recipe"),
    "Recipe: Rice with White Shrimp Meat":           ItemData(ITEM_BASE + 1048, ItemClassification.useful, category="recipe"),
    "Recipe: Roasted Capelin":                       ItemData(ITEM_BASE + 1049, ItemClassification.useful, category="recipe"),
    "Recipe: Roasted Tropical Fish and Garlic":      ItemData(ITEM_BASE + 1050, ItemClassification.useful, category="recipe"),
    "Recipe: Salt-grilled Redtoothed Triggerfish":   ItemData(ITEM_BASE + 1051, ItemClassification.useful, category="recipe"),
    "Recipe: Sea Toad and Cucumber Gunkan Sushi":    ItemData(ITEM_BASE + 1052, ItemClassification.useful, category="recipe"),
    "Recipe: Seagrapes Special Sushi":               ItemData(ITEM_BASE + 1053, ItemClassification.useful, category="recipe"),
    "Recipe: Seahorse Salad":                        ItemData(ITEM_BASE + 1054, ItemClassification.useful, category="recipe"),
    "Recipe: Seasoned Jellyfish":                    ItemData(ITEM_BASE + 1055, ItemClassification.useful, category="recipe"),
    "Recipe: Seasoned Kajime":                       ItemData(ITEM_BASE + 1056, ItemClassification.useful, category="recipe"),
    "Recipe: Seasoned Long-spine Porcupinefish Skin": ItemData(ITEM_BASE + 1057, ItemClassification.useful, category="recipe"),
    "Recipe: Seasoned Waptia Fieldensis":            ItemData(ITEM_BASE + 1058, ItemClassification.useful, category="recipe"),
    "Recipe: Seaweed Rolled Omelet":                 ItemData(ITEM_BASE + 1059, ItemClassification.useful, category="recipe"),
    "Recipe: Shark Karaage":                         ItemData(ITEM_BASE + 1060, ItemClassification.useful, category="recipe"),
    "Recipe: Skewered Cucumber":                     ItemData(ITEM_BASE + 1061, ItemClassification.useful, category="recipe"),
    "Recipe: Smallspotted Dart Kajime Soup":         ItemData(ITEM_BASE + 1062, ItemClassification.useful, category="recipe"),
    "Recipe: Smoked Atlantic Mackerel Scramble":     ItemData(ITEM_BASE + 1063, ItemClassification.useful, category="recipe"),
    "Recipe: Soy Sauce Marinated Crab":              ItemData(ITEM_BASE + 1064, ItemClassification.useful, category="recipe"),
    "Recipe: Special Fried Shrimp Sushi":            ItemData(ITEM_BASE + 1065, ItemClassification.useful, category="recipe"),
    "Recipe: Steamed Hyalonema Angler Fish":         ItemData(ITEM_BASE + 1066, ItemClassification.useful, category="recipe"),
    "Recipe: Stellate Puffer Nicogori":              ItemData(ITEM_BASE + 1067, ItemClassification.useful, category="recipe"),
    "Recipe: Stellate Puffer Special Sushi":         ItemData(ITEM_BASE + 1068, ItemClassification.useful, category="recipe"),
    "Recipe: Stir-fried Habanero Lobster":           ItemData(ITEM_BASE + 1069, ItemClassification.useful, category="recipe"),
    "Recipe: Striped Red Mullet Tangle Roll":        ItemData(ITEM_BASE + 1070, ItemClassification.useful, category="recipe"),
    "Recipe: Three-Colored Squid Roast":             ItemData(ITEM_BASE + 1071, ItemClassification.useful, category="recipe"),
    "Recipe: Tomato Egg Soup":                       ItemData(ITEM_BASE + 1072, ItemClassification.useful, category="recipe"),
    "Recipe: Trevally Nanbanzuke":                   ItemData(ITEM_BASE + 1073, ItemClassification.useful, category="recipe"),
    "Recipe: Trevally Sandwich":                     ItemData(ITEM_BASE + 1074, ItemClassification.useful, category="recipe"),
    "Recipe: Trout Sea Grapes Ricebowl":             ItemData(ITEM_BASE + 1075, ItemClassification.useful, category="recipe"),
    "Recipe: Truffle Blue Lobster Tail Sushi":       ItemData(ITEM_BASE + 1076, ItemClassification.useful, category="recipe"),
    "Recipe: Truffle Sailfish Tartare":              ItemData(ITEM_BASE + 1077, ItemClassification.useful, category="recipe"),
    "Recipe: Truffle Shark Sandwich":                ItemData(ITEM_BASE + 1078, ItemClassification.useful, category="recipe"),
    "Recipe: White Trevally Kombu Ochazuke":         ItemData(ITEM_BASE + 1079, ItemClassification.useful, category="recipe"),
    "Recipe: Whole-Roasted Shark Head":              ItemData(ITEM_BASE + 1080, ItemClassification.useful, category="recipe"),
    "Recipe: Wrasse Curry":                          ItemData(ITEM_BASE + 1081, ItemClassification.useful, category="recipe"),
    "Recipe: Yellowfin Tuna Steak":                  ItemData(ITEM_BASE + 1082, ItemClassification.useful, category="recipe"),
}
